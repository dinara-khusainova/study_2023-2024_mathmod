...
следующих начальных условиях: $x_0=7, y_0=20$. Найдите стационарное
состояние системы.
...
Результаты выполнения программ на Julia (рис.1-3).
...
Результаты выполнения программ с помощью OpenModelica (рис.4-6).

![ График численности хищников от численности жертв](image/2.png){ #fig:004 width=70% }

![График численности жертв и хищников от времени ](image/3.png){ #fig:005 width=70% }


![Стационарное состояние](image/4.png){ #fig:006 width=70% }
